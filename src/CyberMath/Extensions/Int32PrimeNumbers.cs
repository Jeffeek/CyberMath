...
namespace CyberMath.Extensions
{
    ...
    public static class Int32PrimeNumbers
    {
        ...
        {
            if (min < 0) throw new ArgumentOutOfRangeException(nameof(min), "Min was less than zero");
            if (max < 0) throw new ArgumentOutOfRangeException(nameof(max), "Max was less than zero");
            if (min > max) throw new ArgumentOutOfRangeException(nameof(min), "Min was bigger than max");
        ...
        {
            if (max <= 2) throw new ArgumentOutOfRangeException("Max was less or equal 2");
