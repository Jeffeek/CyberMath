...
namespace CyberMath.Extensions
{
    ...
    public static class Int64Extension
    {
        ...
        public static bool IsOdd(this long number) => (number & 1) != 0;
        ...
        /// <summary>
        ///     Calculates greatest common divisor between two <see cref="long"/> numbers
        /// </summary>
        /// <param name="a"></param>
        /// <param name="b"></param>
        ...
        /// <summary>
        ///     Calculates lowest common multiple between two <see cref="long"/> numbers
        /// </summary>
        /// <param name="a"></param>
        /// <param name="b"></param>
        ...
        public static long LCM(this long a, long b)
        {
            ...
            if (quotient != 0 && absB > long.MaxValue / quotient)
                throw new OverflowException($"LCM of {a} and {b} would overflow long.MaxValue");
        ...
        /// <param name="a"></param>
        /// <param name="b"></param>
        public static void Swap(ref this long a, ref long b) => (a, b) = (b, a);

        /// <summary>
        ///     Checks <see cref="long"/> for palindromicity
        /// </summary>
        ...
        /// <summary>
        ///     Calculates the length of <see cref="long"/> number
        /// </summary>
        /// <param name="number"></param>
        ...
        /// <summary>
        ///     Converts <see cref="long"/> <paramref name="number"/> to binary(2) format
        /// </summary>
