...
namespace CyberMath.Structures.Matrices.Extensions
{
    ...
    public static class ValueTypeJuggedMatrixExtensions
    {
        ...
        {
            var juggedMatrix = new JuggedMatrix<int>(matrix.RowsCount,
        ...
        public static IJuggedMatrix<long> Add(this IJuggedMatrix<long> first, IJuggedMatrix<long> second)
        {
            ...
            var juggedMatrix = new JuggedMatrix<long>(first.RowsCount,
                                                      first.CountOnEachRow()
                                                           .ToArray());
        ...
        {
            var juggedMatrix = new JuggedMatrix<long>(matrix.RowsCount,
                                                      matrix.CountOnEachRow()
                                                            .ToArray());
        ...
        public static IJuggedMatrix<double> Add(this IJuggedMatrix<double> first, IJuggedMatrix<double> second)
        {
            ...
            var juggedMatrix = new JuggedMatrix<double>(first.RowsCount,
                                                        first.CountOnEachRow()
                                                             .ToArray());
        ...
        {
            var juggedMatrix = new JuggedMatrix<double>(matrix.RowsCount,
                                                        matrix.CountOnEachRow()
                                                              .ToArray());
        ...
        public static IJuggedMatrix<decimal> Add(this IJuggedMatrix<decimal> first, IJuggedMatrix<decimal> second)
        {
            ...
            var juggedMatrix = new JuggedMatrix<decimal>(first.RowsCount,
                                                         first.CountOnEachRow()
                                                              .ToArray());
        ...
        public static IJuggedMatrix<string> Add(this IJuggedMatrix<string> first, IJuggedMatrix<string> second)
        {
            ...
            var juggedMatrix = new JuggedMatrix<string>(first.RowsCount,
                                                        first.CountOnEachRow()
                                                             .ToArray());
        ...
        {
            var newJuggedMatrix =
                new JuggedMatrix<int?>(juggedMatrix.RowsCount,
        ...
        {
            var newJuggedMatrix =
                new JuggedMatrix<double?>(juggedMatrix.RowsCount,
                                          juggedMatrix.CountOnEachRow()
                                                      .ToArray());
        ...
        /// <param name="min">Minimal value</param>
        /// <param name="max">Maximal value</param>
        public static void FillRandomly(this IJuggedMatrix<double?> juggedMatrix,
                                        double min = -50.0,
                                        double max = 50.0d)
        {
            var rnd = new Random();
