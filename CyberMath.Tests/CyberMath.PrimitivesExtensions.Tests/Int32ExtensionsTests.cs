...
namespace CyberMath.PrimitivesExtensions.Tests
{
	...
	public class Int32ExtensionsTests
	{
		...
		{
			var firstNumbers = new[] { 2, 5, 10, 13, 55 };
			var secondNumbers = new[] { 7, 13, 11, 3, 10 };
			var gcds = new[] { 1, 1, 1, 1, 5 };
		...
		{
			var numbers = new[] { 1, 2, 3, 4, 5, 6, 1100, 12234 };
			var binaries = new[] { "1", "10", "11", "100", "101", "110", "10001001100", "10111111001010" };
		...
		{
			var numbers = new[] { 10, 20, 37, 41, 58, 655, 110550, 112234 };
			var hexes = new[] { "A", "14", "25", "29", "3A", "28F", "1AFD6", "1B66A" };
