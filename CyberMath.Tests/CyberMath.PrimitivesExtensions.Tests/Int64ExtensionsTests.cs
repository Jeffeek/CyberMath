...
namespace CyberMath.PrimitivesExtensions.Tests
{
    ...
    public class Int64ExtensionsTests
    {
        ...
        {
            for (var i = Int64.MinValue; i < 0; i /= 10)
            {
                long expect = i < 0
                                  ? i.ToString()
                                     .Length
            ...
            var expectMaxValue = Int64.MaxValue.ToString()
                                      .Length;

            var actualMaxValue = Int64.MaxValue.GetLength();
        ...
        {
            var firstNumbers = new long[]
                               {
                                   205151, 5564561, 564351563, 5643516, 564131
                               };

            var secondNumbers = new long[]
                                {
                                    751451, 54646, 4564645, 545, 545
                                };
        ...
        public void LCM_test()
        {
            var firstNumbers = new long[]
                               {
                                   2556465, 5415, 545, 5451, 65456
                               };

            var secondNumbers = new long[]
                                {
                                    745, 4545, 5415, 463, 5456
                                };

            var lcms = new long[]
                       {
                           380913285, 1640745, 590235, 2523813, 22320496
                       };
